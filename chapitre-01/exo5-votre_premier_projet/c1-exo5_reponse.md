...
**Nom du projet :** `MonEssai`
**Emplacement du projet :** `Applications/MonEssai/`
...
```
## 3. Fichier de construction (MonEssai.jenga)
```Python
from Jenga import *
...
## 4. Déclaration au Workspace (Nkentseu.jenga)
Ligne ajoutée dans le fichier racine Nkentseu.jenga pour que Jenga reconnaisse le nouveau projet :
...
## 5. Étapes de vérification et résultats
### Détection du projet :

Commande exécutée : `jenga info`
...
Location: D:\2DS\projet\programmation cpp\Nkentseu
Entry file: D:\2DS\projet\programmation cpp\Nkentseu\Nkentseu.jenga
...
Status: Not running
```
Le projet MonEssai apparaît correctement dans la liste des projets déclarés sous le type ConsoleApp.

### Compilation du projet :

Commande exécutée : jenga build --project MonEssai 

Résultat :
```

PS D:\2DS\projet\programmation cpp\Nkentseu> jenga build --project MonEssai 
...
L'excutable a été généré sans erreur sous Build/Bin/Debug-Windows/MonEssai/MonEssai.exe.